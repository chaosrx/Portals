...
namespace SKSStudios.Portals.VR {
    public class PortalController : MonoBehaviour {
        ...
        public GameObject targetInitializer;
        ...
        //Should the portals be optimized for maximum frames? Warning: Due to a Unity bug, this can break dynamic lights through portals.
        [HideInInspector]
